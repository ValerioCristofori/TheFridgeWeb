...
public class ChangeFridgeController {
	...
	public BeanChangeFridge takeInvitations() throws EmptyInvitationException {
		String username = SingletonInstances.getSingletonInstance().getCurrentUser().getUsername();
	...
	public String takeUsername() {
		return SingletonInstances.getSingletonInstance().getCurrentUser().getUsername();
	}
	
	public String takeEmail() {
		return SingletonInstances.getSingletonInstance().getCurrentUser().getEmailAddress();
	}
	
	public String takeMyFridgeName() {
		return SingletonInstances.getSingletonInstance().getMyFridge().getName();
	}
