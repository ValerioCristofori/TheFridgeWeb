...
<head>
    ...
    $( function() {
        var availableTags = [
        	"Achacha","Agave-Syrup","Agave-Syrup","Alfalfa","Almond-oil","Albacore-Tuna",
...
<body>
	<div>
		...
		<div class="addFood">
			<h2 style="font-family: 'Montserrat', sans-serif; color: sandybrown;" align="CENTER">Add food to your fridge</h2><br>
			...
			<input id="quantityInpId" type="text" name="quantity" placeholder="insert quantity" autocomplete="off"><br><br>
			<input id="dateInpId" type="date" name="date" placeholder="insert expiration date" autocomplete="off" ><br><br>
			<input id="addFoodButtonId" type="submit" name="add" value="Add Food" style="font-family: 'Montserrat', sans-serif;"><br><br>
			</form>
		</div>
