	...
	<div>
		...
		<div class="profile_div" style="align: center; float: left;">
				...
				<form action="profile" id="profileForm" method="post" >
					...
					<input type="submit" name="actionProfile" value="DeleteAccount" style="font-family: 'Montserrat', sans-serif; background-color: #E14D43; margin-top: 125px; "><br><br>
		  		</form>
		  </div>
		  <div style="float: right;margin-top: 40px;">	
			 ...
			 <div class="case" style="margin-right:150px; padding-top:10px;">
				 	...
				 	<label style="font-family: 'Montserrat', sans-serif; font-size: 14px; margin-left: 90px; color: #ed4337;">
				 	<c:out  value="${alertLabel}"></c:out>
				 	</label>
				 	<table id="dataTable"  style="width:100%">
					 	<tbody>
						  <tr>
						    <th style="font-family: 'Montserrat', sans-serif; color: white;">Invitation by</th>
						    <th style="font-family: 'Montserrat', sans-serif; color: white;">Message</th>
						  		...
						  		for( int i=0; i<changeFridgeUI.getInvitingUsers().size() ; i++ ){
						  			...
						  			<tr style="text-align:center;">
							  			<td style="font-family: 'Montserrat', sans-serif; margin-left: 50px; " >
							            	<label for="name"style="font-family: 'Montserrat', sans-serif; font-size:14px; color: white; font-weight:bold;"><%=name %></label>
							            	
							        	</td>
							   
							        	<td>
							            	<div class="popup" onclick="popupClicked('<%=i%>')">
							            		<img src="images/message.png" alt="message"  width="30" >
					...
					<%
						  			...
						  			<h3 style="font-family: 'Montserrat', sans-serif; color:white;" align="CENTER" >No invitations</h3>
						  			<%
						  		}
								%>
		 	...
		 	<div class="case" style="margin-top: 30px; padding:60px;">		 		
			 		...
			 		<%	try{
				 			...
				 			for( String fridge: fridges ){
				 				...
				 				<!-- <input id="indexId" type="hidden" name="index" /> -->
						        	<button onclick="fridgeClicked('<%=i%>')" style="border: none; background-color: transparent;" ><img src="images/fridgeWeb.png" alt="fridge"  width="130"  ></button>
				 					<label style="font-family: 'Montserrat', sans-serif; font-size: 11px; color: white;"><%=fridge %></label>
				 				</div>
				 				<%
				 				i++;
				 			}
			 				...
			 				%>
			 				<h3 style="font-family: 'Montserrat', sans-serif; color:white;" align="CENTER" >No shared fridges</h3>
			 				<%
			 			}
			 		%>
			 		</div>
